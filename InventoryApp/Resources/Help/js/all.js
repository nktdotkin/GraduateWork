...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Справочная система Inventory App","Поставщики","Клиенты","Товары","Поставки и отгрузки","Настройки","Статистика"],
	DREX_NODE_LINKS: ["spravochnaya_sistema_inventory_app.htm","postavshchiki.htm","klienty.htm","tovary.htm","postavki_i_otgruzki.htm","nastrojki.htm","statistika.htm"],
